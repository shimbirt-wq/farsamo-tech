...
import { confirmPickup, DeviceCustodyValidationError } from "@/lib/service-desk/device-custody";
...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    ...
    if (error instanceof DeviceCustodyValidationError) {
      return validationErrorResponse("Invalid pickup confirmation data.", error.validationError);
    }
