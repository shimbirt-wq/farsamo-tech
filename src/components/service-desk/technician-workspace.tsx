    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="break-all text-sm font-black text-[var(--foreground)]">{ticket.trackingCode ?? ticket.ticketId}</p>
      ...
      <section className="grid gap-4 content-start">
        <div className="panel p-5">
          ...
          <p className="mt-3 text-sm leading-7 text-[var(--muted)]">
            Work only from assigned repairs. Open a ticket to diagnose, record notes, request requester action, or submit for verification.
          </p>
        </div>
